...
export default {
  ...
  created(){
    ...
    // if(document.getElementById("mp3").play()){
    //   this.stop=true
    // }else{
    //   this.stop=false
    // }
    ...
    // console.log(document.getElementById("mp3").currentTime)
        ...
        //歌曲ID
        sing.$on('message',this.getsingId)
        sing.$on('message',this.getsingUrl)
        sing.$on('message',this.getsingsyas)
...
methods:{
    getsingId(v){
          this.singid = v;
          if(typeof(this.singid)!='undefined'){
    ...
    getsingUrl(v){
      ...
      if(typeof(this.singid)!='undefined'){
        ...
        this.singid='1396237984'
        this.singurl="http://m7.music.126.net/20200122142024/c25bfabcf059f92b9056fff3b7d6269b/ymusic/0e59/515e/5209/93e968a365f4836e75cbecf8133aad99.flac"
      }
    },
    //获取歌词
    getsingsyas(v){
